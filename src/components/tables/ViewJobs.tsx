          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {jobs.map((job) => (
              <TableRow key={job.id}>
                ...
                <TableCell className="px-5 py-4  text-gray-500 text-theme-sm dark:text-gray-400"><Badge
                    size="sm"
                    color={
                      job.priority === "high"
                        ? "success"
              ...
              <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">{job.serviceCharge}</TableCell>
              <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                <Button
              size="sm"
              variant="outline"
