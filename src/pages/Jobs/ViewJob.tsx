...
import { Calendar, DollarSign, User, Car, Clock, CheckCircle, XCircle, AlertCircle, ArrowLeft, Edit } from 'lucide-react';
...
export default async function ViewJobPage (){
  ...
  const currentJob :Job|null = await useJobs().getJobById(Number(jobId));
...
<div>
      ...
      />
      <PageBreadcrumb pageTitle="View Job Details" />
